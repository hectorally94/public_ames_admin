...
import { useUpdateVersionMutation } from "../../../features/api/versionsApiSlice";
...
const ModalTypeVersionEdit: React.FC<ModalTypeVersionEditProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await updateVersion({
        id: selectedType?.id!,
        data: { versionName:type } // Pass `type` as part of the `data` field
      });
...
export default ModalTypeVersionEdit;
