...
import ModalHistoireSuccessEdit from './ModalHistoireSuccessEdit';
import { HistoireSuccessDto, useDeleteHistoireSuccessMutation, useGetAllHistoireSuccessDtoQuery } from '../../../features/api/histoireSuccessApiSlice';
...
const MyTableHistoireSuccess = () => {

  // Fetch data using the hook
  const { data, error, isLoading } = useGetAllHistoireSuccessDtoQuery()
  const [deleteData] = useDeleteHistoireSuccessMutation(); // Import the mutation hook
 ...
 useEffect(() => {
  ...
  const packageData = (data as unknown as TypeResponse)?.data || [];
  ...
  >
    ...
    />
      ...
      <ModalHistoireSuccessEdit  isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} />
      </div>
    </div>
  );
};

export default MyTableHistoireSuccess;
