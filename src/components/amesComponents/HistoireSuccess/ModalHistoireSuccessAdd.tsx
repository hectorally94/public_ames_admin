...
import { useCreateHistoireSuccessMutation } from "../../../features/api/histoireSuccessApiSlice";

interface ModalHistoireSuccessAddProps {
  isOpen: boolean;
  onClose: () => void;
}

const ModalHistoireSuccessAdd: React.FC<ModalHistoireSuccessAddProps> = ({ isOpen, onClose }) => {
...
console.log("selectedId",selectedId)
  ...
  const [Create] = useCreateHistoireSuccessMutation()
...
if (!description) {
  ...
  return;
    ...
    try {
        await Create({ title:title , description: description,languageId:selectedId}).unwrap();
        setAlert({
          type: "success",
          title: "Success",
...
export default ModalHistoireSuccessAdd;
