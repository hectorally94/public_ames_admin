...
import { useCreateMissionMutation } from "../../../features/api/missionsApiSlice";
...
const ModalAddMissionImageStore: React.FC<ModalAddTypeImageImageStoreProps> = ({ isOpen, onClose }) => {
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="mb-4.5">
                ...
                <input
                  ...
                  placeholder="Enter mission's title"
...
export default ModalAddMissionImageStore;
