...
import { useUpdateMissionMutation } from "../../../features/api/missionsApiSlice";
...
const ModalMissionImageStoreEdit: React.FC<ModalProps> = ({ isOpen, onClose }) => {
...
export default ModalMissionImageStoreEdit;
