...
import { useGetAllImage_partenaireimagesAllQuery } from "../../../features/api/storePartenaireApiSlice";
import ModalAddPartenaireImageStore from "./ModalAddPartenaireImageStore";

interface ModalImage_partenaireimagesAddProps {
  isOpen: boolean;
  onClose: () => void;
}

const ModalLoadPartenaireImageStore: React.FC<ModalImage_partenaireimagesAddProps> = ({ isOpen, onClose }) => {
...
{data?.map((packageItem, key) => (
  ...
  <Base64Image base64String= {packageItem.imagedata} />
    ...
    <div className="mt-3 mb-3 flex items-center space-x-3.5">
      ...
      <ModalAddPartenaireImageStore  isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} />
      </div>
    </div>
...
export default ModalLoadPartenaireImageStore;
