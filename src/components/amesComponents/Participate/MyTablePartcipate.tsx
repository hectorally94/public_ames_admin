...
import ModalPartcipateEdit from './ModalPartcipateEdit';
import { ParticipableDto, useDeleteParticipableMutation, useGetAllParticipablesDtosQuery } from '../../../features/api/participablesApiSlice';
...
const MyTablePartcipate = () => {

  // Fetch data using the hook
  const { data, error, isLoading } = useGetAllParticipablesDtosQuery();
  const [deleteParticipable] = useDeleteParticipableMutation(); // Import the mutation hook
 ...
 useEffect(() => {
  ...
  >
    ...
    />
      ...
      <ModalPartcipateEdit  isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} />
      </div>
    </div>
  );
};

export default MyTablePartcipate;
