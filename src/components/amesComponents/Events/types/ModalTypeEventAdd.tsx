...
import { useCreateTypeEventMutation } from "../../../../features/api/typeEventsApiSlice";
...
const ModalTypeEventAdd: React.FC<ModalTypeActionAddProps> = ({ isOpen, onClose }) => {
  const [type, setType] = useState<string>("");
  const [createTypeEvent] = useCreateTypeEventMutation();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        await createTypeEvent({ type }).unwrap();
        setAlert({
          type: "success",
          title: "Success",
...
export default ModalTypeEventAdd;
