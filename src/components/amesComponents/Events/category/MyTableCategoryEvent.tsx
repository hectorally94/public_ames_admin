...
import { CategoryEvent, useDeleteCategoryEventMutation, useGetAllCategoryEventsQuery } from '../../../../features/api/categoryEventApiSlice';
import ModalCategoryEventEdit from './ModalCategoryEventEdit';
...
const MyTableCategoryEvent = () => {

  // Fetch data using the hook
  const { data, error, isLoading } = useGetAllCategoryEventsQuery();
  const [deleteType] = useDeleteCategoryEventMutation(); // Import the mutation hook
 ...
 useEffect(() => {
  ...
  >
    ...
    />
      ...
      <ModalCategoryEventEdit  isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} />
      </div>
    </div>
  );
};

export default MyTableCategoryEvent;
