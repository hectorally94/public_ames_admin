...
import { useCreateCategoryEventMutation } from "../../../../features/api/categoryEventApiSlice";
...
const ModalCategoryEventAdd: React.FC<ModalCategoryActionAddProps> = ({ isOpen, onClose }) => {
  const [categoryName, setCategoryName] = useState<string>("");

  const [createCategoryEvent] = useCreateCategoryEventMutation()
...
export default ModalCategoryEventAdd;
