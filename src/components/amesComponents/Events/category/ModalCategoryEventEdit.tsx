// components/ModalCategoryEventEdit.tsx
...
import { useUpdateCategoryEventMutation } from "../../../../features/api/categoryEventApiSlice";

interface ModalCategoryEventEditProps {
  isOpen: boolean;
  onClose: () => void;
}

const ModalCategoryEventEdit: React.FC<ModalCategoryEventEditProps> = ({ isOpen, onClose }) => {
  ...
  const [updateCategoryEvent] = useUpdateCategoryEventMutation();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Call the updateTypeEvent mutation
      const response = await updateCategoryEvent({
      ...
      // Check the response and dispatch the appropriate Event
          ...
          <div className="p-6.5">
            <div className="mb-4.5">
              ...
              <input
                ...
                placeholder="Enter your TypeEvent"
...
export default ModalCategoryEventEdit;
