...
import { useUpdateTypeEventsTranslateMutation } from "../../../../features/api/typeEventsTranslateApiSlice";
...
const ModalTypeEventTranslateEdit: React.FC<ModalTypeVersionEditProps> = ({ isOpen, onClose }) => {
  ...
  const [updateVersion] = useUpdateTypeEventsTranslateMutation()
...
export default ModalTypeEventTranslateEdit;
