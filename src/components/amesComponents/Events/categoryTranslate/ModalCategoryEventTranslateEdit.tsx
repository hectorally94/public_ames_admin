...
import { useUpdateCategoryEventTranslateMutation } from "../../../../features/api/categoryEventTranslateApiSlice";
...
const ModalCategoryActionTranslateEdit: React.FC<ModalTypeVersionEditProps> = ({ isOpen, onClose }) => {
  ...
  const [updateVersion] = useUpdateCategoryEventTranslateMutation()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await updateVersion({
        id: selectedType?.id!,
        data: { categoryEventTranslate:type } // Pass `type` as part of the `data` field
      });
...
export default ModalCategoryActionTranslateEdit;
