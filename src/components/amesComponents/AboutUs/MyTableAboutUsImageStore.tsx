...
import ModalAboutUsImageStoreEdit from './ModalAboutUsImageStoreEdit';
import { AboutUsDTO, useDeleteAboutUsMutation, useGetAllAboutUsDtoQuery } from '../../../features/api/aboutUsApiSlice';
...
const MyTableAboutUsImageStore = () => {

  // Fetch data using the hook
  const { data, error, isLoading } = useGetAllAboutUsDtoQuery()
  const [deleteData] = useDeleteAboutUsMutation () // Import the mutation hook
...
{packageData?.map((packageItem, key) => (
  ...
  <Base64Image base64String= {packageItem.imageData} />
    ...
    <div className="mt-3 mb-3 flex items-center space-x-3.5">
      ...
      <ModalAboutUsImageStoreEdit  isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} />
      </div>
    </div>
  );
};

export default MyTableAboutUsImageStore;
