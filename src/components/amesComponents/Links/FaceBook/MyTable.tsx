...
import { useDeleteLinkFaceBookMutation, useGetAllLinkFaceBooksQuery } from '../../../../features/api/linkFaceApiSlice';
...
const MyTable = () => {
  ...
  const { data, error, isLoading } = useGetAllLinkFaceBooksQuery();
  const [deleteLanguage] = useDeleteLinkFaceBookMutation(); // Import the mutation hook
