...
import { useDeleteLinkInstagramMutation, useGetAlllinkInstagramQuery } from '../../../../features/api/linkInstagramApiSlice';
...
const MyTable = () => {
  ...
  const { data, error, isLoading } = useGetAlllinkInstagramQuery();
  const [deletelink] = useDeleteLinkInstagramMutation(); // Import the mutation hook
 ...
 useEffect(() => {
  ...
  const confirmDelete = async () => {
    if (deleteId !== null) {
      ...
      try {
        await deletelink(deleteId).unwrap();
        setAlert({
          type: 'success',
          title: 'Success',
