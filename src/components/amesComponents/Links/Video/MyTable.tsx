...
import { useDeleteLinkVideosMutation, useGetAlllinkVideosQuery } from '../../../../features/api/linkVideoSlice';
...
const MyTable = () => {
  ...
  const { data, error, isLoading } = useGetAlllinkVideosQuery();
  const [deletelink] = useDeleteLinkVideosMutation(); // Import the mutation hook
