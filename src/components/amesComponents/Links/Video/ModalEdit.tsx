...
import { useUpdateLinkVideosMutation } from "../../../../features/api/linkVideoSlice";
...
const ModalEdit: React.FC<ModalEditProps> = ({ isOpen, onClose }) => {
    ...
    const [updatelink] = useUpdateLinkVideosMutation();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        const response = await updatelink({ id: selectedLanguage?.id!, name });
