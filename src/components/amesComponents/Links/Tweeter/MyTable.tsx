...
import { useDeleteLinkTweeterMutation, useGetAlllinkTweeterQuery } from '../../../../features/api/linkTweeterApiSlice';
...
const MyTable = () => {
  ...
  const { data, error, isLoading } = useGetAlllinkTweeterQuery();
  const [deletelink] = useDeleteLinkTweeterMutation(); // Import the mutation hook
