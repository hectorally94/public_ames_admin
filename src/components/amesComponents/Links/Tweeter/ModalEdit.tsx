...
import { RootState } from "../../../../common/rootReducer";
 import { useUpdateLinkTweeterMutation } from "../../../../features/api/linkTweeterApiSlice";
...
const ModalEdit: React.FC<ModalEditProps> = ({ isOpen, onClose }) => {
    ...
    const [updateLanguage] = useUpdateLinkTweeterMutation();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      setLoading(true)
      try {
        // Call the updateLanguage mutation
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="p-6.5">
            ...
            >
              ...
              {loading ? <SmallLoader /> : 'Edit Language '}
            </button>
          </div>
        </div>
      </form>
