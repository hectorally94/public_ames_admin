...
import { useDeleteLanguageMutation, useGetAllLanguagesQuery, useUpdateLanguageMutation } from '../../../features/api/languageApiSlice';
...
const MyTable = () => {
  ...
  const { data, error, isLoading } = useGetAllLanguagesQuery();
  const [deleteLanguage] = useDeleteLanguageMutation(); // Import the mutation hook
