...
import { useUpdateCategoryBlogTranslateMutation } from "../../../../features/api/categoryBlogTranslateApiSlice";
...
const ModalCategoryBlogTranslateEdit: React.FC<ModalTypeVersionEditProps> = ({ isOpen, onClose }) => {
  ...
  const [updateVersion] = useUpdateCategoryBlogTranslateMutation()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await updateVersion({
        id: selectedType?.id!,
        data: { categoryBlogTranslate:type } // Pass `type` as part of the `data` field
      });
...
export default ModalCategoryBlogTranslateEdit;
