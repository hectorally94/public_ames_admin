...
import { useCreateCategoryBlogMutation } from "../../../../features/api/categoryBlogApiSlice";
...
const ModalCategoryBlogAdd: React.FC<ModalCategoryActionAddProps> = ({ isOpen, onClose }) => {
...
export default ModalCategoryBlogAdd;
