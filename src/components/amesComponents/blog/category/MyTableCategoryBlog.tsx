...
import { CategoryBlog, useDeleteCategoryBlogMutation, useGetAllCategoryBlogsQuery } from '../../../../features/api/categoryBlogApiSlice';
import { setCategoryActionPayload } from '../../../../features/reduxSlices/categoryActionSlice';
import ModalCategoryBlogEdit from './ModalCategoryBlogEdit';
...
const MyTableCategoryBlog = () => {

  // Fetch data using the hook
  const { data, error, isLoading } = useGetAllCategoryBlogsQuery();
  const [deleteType] = useDeleteCategoryBlogMutation(); // Import the mutation hook
 ...
 useEffect(() => {
  ...
  >
    ...
    />
      ...
      <ModalCategoryBlogEdit  isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} />
      </div>
    </div>
  );
};

export default MyTableCategoryBlog;
