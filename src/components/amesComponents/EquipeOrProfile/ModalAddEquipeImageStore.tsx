...
import { useCreateNotreEquipeMutation } from "../../../features/api/notreEquipeApiSlice";
...
const ModalAddEquipeImageStore: React.FC<ModalAddTypeImageImageStoreProps> = ({ isOpen, onClose }) => {
  ...
  const [Create] = useCreateNotreEquipeMutation();
...
export default ModalAddEquipeImageStore;
