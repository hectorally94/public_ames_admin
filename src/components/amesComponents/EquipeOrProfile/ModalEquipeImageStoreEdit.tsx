...
import { useUpdateNotreEquipeMutation } from "../../../features/api/notreEquipeApiSlice";
...
const ModalEquipeImageStoreEdit: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  ...
  const [Update] = useUpdateNotreEquipeMutation();
...
export default ModalEquipeImageStoreEdit;
