...
import { useUpdateWelcomeMutation } from "../../../features/api/welcomesApiSlice";
...
const ModalwelcomesTranslateEdit: React.FC<ModalTypeVersionEditProps> = ({ isOpen, onClose }) => {
  ...
  const [updateVersion] = useUpdateWelcomeMutation()
...
export default ModalwelcomesTranslateEdit;
