...
import { useDeleteWelcomeMutation, useGetAllWelcomesDtoQuery, useGetAllWelcomesQuery, WelcomesDto } from '../../../features/api/welcomesApiSlice';
import ModalwelcomesTranslateEdit from './ModalwelcomesTranslateEdit';
import { setDatapassTwoPayload } from '../../../features/reduxSlices/passDataTwo';
...
const MyTablewelcomesTranslate = () => {

  // Fetch data using the hook
  const { data, error, isLoading } = useGetAllWelcomesDtoQuery()
  const [deleteParticipable] = useDeleteWelcomeMutation(); // Import the mutation hook
 ...
 useEffect(() => {
  ...
  const handleEdit = (selectedPackageItem:any) => {
    ...
    dispatch(setDatapassTwoPayload(selectedPackageItem))
  ...
  >
    ...
    />
      ...
      <ModalwelcomesTranslateEdit  isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} />
      </div>
    </div>
  );
};

export default MyTablewelcomesTranslate;
