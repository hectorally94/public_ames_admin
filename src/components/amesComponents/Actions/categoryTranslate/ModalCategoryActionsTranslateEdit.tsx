...
import { useUpdateCategoryActionTranslateMutation } from "../../../../features/api/categoryActionTranslateApiSlice";
...
const ModalCategoryActionsTranslateEdit: React.FC<ModalTypeVersionEditProps> = ({ isOpen, onClose }) => {
  ...
  const [updateVersion] = useUpdateCategoryActionTranslateMutation()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await updateVersion({
        id: selectedType?.id!,
        data: { categoryTranslate:type } // Pass `type` as part of the `data` field
      });
...
export default ModalCategoryActionsTranslateEdit;
