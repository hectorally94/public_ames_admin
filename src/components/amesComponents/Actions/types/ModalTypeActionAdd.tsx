...
import { useCreateTypeActionMutation } from "../../../../features/api/typeActionsApiSlice";
...
const ModalTypeActionAdd: React.FC<ModalTypeActionAddProps> = ({ isOpen, onClose }) => {
  const [type, setType] = useState<string>("");
  const [createTypeAction] = useCreateTypeActionMutation();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        await createTypeAction({ type }).unwrap();
        setAlert({
          type: "success",
          title: "Success",
...
export default ModalTypeActionAdd;
