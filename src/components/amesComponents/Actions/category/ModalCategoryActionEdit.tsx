// components/ModalCategoryActionEdit.tsx
...
import { useUpdateCategoryActionMutation } from "../../../../features/api/categoryActionApiSlice";

interface ModalCategoryActionEditProps {
  isOpen: boolean;
  onClose: () => void;
}

const ModalCategoryActionEdit: React.FC<ModalCategoryActionEditProps> = ({ isOpen, onClose }) => {
  ...
  const [updateCategoryAction] = useUpdateCategoryActionMutation();
...
export default ModalCategoryActionEdit;
