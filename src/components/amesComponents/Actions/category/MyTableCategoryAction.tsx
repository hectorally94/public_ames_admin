...
import { CategoryAction, useDeleteCategoryActionMutation, useGetAllCategoryActionsQuery } from '../../../../features/api/categoryActionApiSlice';
import { setCategoryActionPayload } from '../../../../features/reduxSlices/categoryActionSlice';
import ModalCategoryActionEdit from './ModalCategoryActionEdit';
...
const MyTableCategoryAction = () => {

  // Fetch data using the hook
  const { data, error, isLoading } = useGetAllCategoryActionsQuery();
  const [deleteType] = useDeleteCategoryActionMutation(); // Import the mutation hook
 ...
 useEffect(() => {
  ...
  const handleEdit = (selectedPackageItem:any) => {
    ...
    dispatch(setCategoryActionPayload(selectedPackageItem))
    setIsEditModalOpen(true)
  }
   // Handler for deleting a Type
  ...
  >
    ...
    />
      ...
      <ModalCategoryActionEdit  isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} />
      </div>
    </div>
  );
};

export default MyTableCategoryAction;
