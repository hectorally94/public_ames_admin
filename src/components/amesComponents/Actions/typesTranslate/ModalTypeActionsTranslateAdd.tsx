...
import { useCreateTypeActionsTranslateMutation } from "../../../../features/api/typeActionsTranslateApiSlice";
...
const ModalTypeActionsTranslateAdd: React.FC<ModalTypeActionAddProps> = ({ isOpen, onClose }) => {
  const selectedId = useSelector((state: RootState) => state.languageid.selectedId);
console.log("selectedId",selectedId)

  const [type, setType] = useState<string>("");
  const [CreateParticipable] = useCreateTypeActionsTranslateMutation();
...
export default ModalTypeActionsTranslateAdd;
