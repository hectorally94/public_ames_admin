...
import { ActionDto, useDeleteActionMutation, useGetPaginatedActionsQuery } from '../../../../features/api/actionsApiSlice';
...
/// pagination config
  ...
  const { data, error, isLoading } = useGetPaginatedActionsQuery({ title, page: currentPage, size: itemsPerPage, sort });
 
  const [deleteData] = useDeleteActionMutation () // Import the mutation hook
