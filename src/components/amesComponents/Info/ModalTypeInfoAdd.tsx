...
import { useCreateInfoMutation } from "../../../features/api/infoApiSlice";
import Modal from "../../modal/Modal";
import Alert from "../AmesAlert/Alert";
import SmallLoader from "../../../common/Loader/SmallLoader";

interface ModalInfoAddProps {
  isOpen: boolean;
  onClose: () => void;
}

const ModalTypeInfoAdd: React.FC<ModalInfoAddProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        await createInfo({ infoType:type }).unwrap();
        setAlert({
          type: "success",
          title: "Success",
...
export default ModalTypeInfoAdd;
