...
import { useUpdateImpactMutation } from "../../../features/api/impactsApiSlice";
...
const ModalImpactEdit: React.FC<ModalTypeEditProps> = ({ isOpen, onClose }) => {
  ...
  const [update] = useUpdateImpactMutation()
...
export default ModalImpactEdit;
