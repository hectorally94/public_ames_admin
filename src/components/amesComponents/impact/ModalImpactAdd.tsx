...
import { useCreateImpactMutation } from "../../../features/api/impactsApiSlice";

interface ModalImpactAddProps {
  isOpen: boolean;
  onClose: () => void;
}

const ModalImpactAdd: React.FC<ModalImpactAddProps> = ({ isOpen, onClose }) => {
...
console.log("selectedId",selectedId)
  ...
  const [Create] = useCreateImpactMutation()
