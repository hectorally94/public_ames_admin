...
import {  useUpdateImage_partenaireimagesMutation } from "../../../../features/api/storePartenaireApiSlice";
...
const ModalImgPartenaireEdit: React.FC<ModalImage_partenaireimagesAddProps> = ({ isOpen, onClose }) => {
  const selectedId = useSelector((state: RootState) => state.imgIdSlice.payload);
  console.log("selectedId", selectedId);

  const [Create] = useUpdateImage_partenaireimagesMutation();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await Create({id:selectedId,formData}).unwrap();
      setAlert({
        type: "success",
        title: "Success",
...
export default ModalImgPartenaireEdit;
