...
import { useCreateImage_partenaireimagesMutation } from "../../../../features/api/storePartenaireApiSlice";
...
const ModalPartenaireAdd: React.FC<ModalImage_partenaireimagesAddProps> = ({ isOpen, onClose }) => {
  const selectedId = useSelector((state: RootState) => state.languageid.selectedId);
  console.log("selectedId", selectedId);

  const [Create] = useCreateImage_partenaireimagesMutation();
...
export default ModalPartenaireAdd;
