// components/ModalTypeImageEdit.tsx
...
import { useUpdateTypeImageMutation } from "../../../../features/api/typeImagesApiSlice";

interface ModalTypeImageEditProps {
  isOpen: boolean;
  onClose: () => void;
}

const ModalTypeImageEdit: React.FC<ModalTypeImageEditProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await updateTypeImage({
        id: selectedType?.id!,
...
export default ModalTypeImageEdit;
