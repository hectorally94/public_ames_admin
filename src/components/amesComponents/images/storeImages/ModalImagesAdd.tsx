...
import { useCreateImage_store_imagesMutation } from "../../../../features/api/storeImageApiSlice";
...
const ModalImagesAdd: React.FC<ModalImage_profilesimageAddProps> = ({ isOpen, onClose }) => {
  const selectedId = useSelector((state: RootState) => state.languageid.selectedId);
  console.log("selectedId", selectedId);

  const [Create] = useCreateImage_store_imagesMutation();
