...
import { TypeImageTranslateDto, useDeleteTypeImageTranslateMutation, useGetAllTypeImageTranslateDtosQuery } from '../../../../features/api/typeImageTranslateApiSlice';
import ModalTypeImageTranslateEdit from './ModalTypeImageTranslateEdit';
...
const MyTableTypeImagesTranslate = () => {

  // Fetch data using the hook
  const { data, error, isLoading } = useGetAllTypeImageTranslateDtosQuery();
  const [deleteParticipable] = useDeleteTypeImageTranslateMutation(); // Import the mutation hook
 ...
 useEffect(() => {
  ...
  const packageData = (data as unknown as TypeImagesResponse)?.data || [];
   // Handler for editing a TypeImage
  ...
  >
    ...
    />
      ...
      <ModalTypeImageTranslateEdit  isOpen={isEditModalOpen} onClose={() => setIsEditModalOpen(false)} />
      </div>
    </div>
  );
};

export default MyTableTypeImagesTranslate;
