...
import { useCreateTypeImageTranslateMutation } from "../../../../features/api/typeImageTranslateApiSlice";

interface ModalTypeImageAddProps {
  isOpen: boolean;
  onClose: () => void;
}

const ModalTypeImageTranslateAdd: React.FC<ModalTypeImageAddProps> = ({ isOpen, onClose }) => {
  const selectedId = useSelector((state: RootState) => state.languageid.selectedId);
console.log("selectedId",selectedId)

  const [type, setType] = useState<string>("");
  const [CreateParticipable] = useCreateTypeImageTranslateMutation();
...
export default ModalTypeImageTranslateAdd;
