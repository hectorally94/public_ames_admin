...
import { useUpdateTypeImageTranslateMutation } from "../../../../features/api/typeImageTranslateApiSlice";
...
const ModalTypeImageTranslateEdit: React.FC<ModalTypeVersionEditProps> = ({ isOpen, onClose }) => {
  ...
  const [updateVersion] = useUpdateTypeImageTranslateMutation()
...
export default ModalTypeImageTranslateEdit;
