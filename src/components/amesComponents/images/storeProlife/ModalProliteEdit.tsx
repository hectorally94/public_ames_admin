...
import { useUpdateImage_profilesimagesMutation } from "../../../../features/api/storeProfileApiSlice";
...
const ModalProliteEdit: React.FC<ModalImage_profilesimagesAddProps> = ({ isOpen, onClose }) => {
  const selectedId = useSelector((state: RootState) => state.imgIdSlice.payload);
  console.log("selectedId", selectedId);

  const [Update] = useUpdateImage_profilesimagesMutation();
...
export default ModalProliteEdit;
