...
import { useCreateImage_profilesimagesMutation } from "../../../../features/api/storeProfileApiSlice";
...
const ModalProliteAdd: React.FC<ModalImage_profilesimageAddProps> = ({ isOpen, onClose }) => {
  const selectedId = useSelector((state: RootState) => state.languageid.selectedId);
  console.log("selectedId", selectedId);

  const [Create] = useCreateImage_profilesimagesMutation();
...
export default ModalProliteAdd;
