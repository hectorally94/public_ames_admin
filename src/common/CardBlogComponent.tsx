import React from 'react';
 import { BlogDto } from '../features/api/blogsApiSlice';
...
interface ActionCardProps {
  ...
  clanaguage:string;
  date:string; 
  action: BlogDto; // Ensure this is correctly typed
  onEdit: (action: BlogDto) => void; // Correctly typing the onEdit function

  onDelete: (id: number) => void;
}

const CardBlogComponent: React.FC<ActionCardProps> = ({
  id,
  imageSrc,
  title,
  objectif,
