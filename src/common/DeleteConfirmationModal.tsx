...
interface DeleteConfirmationModalProps {
  ...
  onClose: () => void;
  onConfirm: () => void;
  itemName?: string; // Optional item name to show in the modal
}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto">
      <div className="relative w-full max-w-md h-full md:h-auto">
        <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          <button
            type="button"
            className="absolute top-2.5 right-2.5 text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-200 dark:hover:bg-gray-600 p-1.5 rounded-lg"
            onClick={onClose}
          >
            <svg
              aria-hidden="true"
